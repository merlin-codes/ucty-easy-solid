import { Accessor, createEffect, Setter, writeSignal } from "solid-js/types/reactive/signal";
...
export const Opt: Component<OptProps> = (props) => {
    ...
    function del(e: Event) {
        ...
        props.setOpts([...props.opts.slice(0, s), ...props.opts.slice(s)])
        props.sh([...props.h, {type: OHT.DEL, old: props.opts[parseInt(x.value)], i: parseInt(x.value)}])
    }
    function check(e: Event, n: number, n1: MOVE) {
        ...
        props.sh([...props.h, {type: OHT.MOVE, old: props.opts[val], i: val, m: n1}])
    }
